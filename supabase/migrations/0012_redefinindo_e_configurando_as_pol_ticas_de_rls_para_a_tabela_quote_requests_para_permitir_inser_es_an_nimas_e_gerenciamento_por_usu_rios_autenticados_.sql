...
-- 4. Concede TODOS os privilégios (temporariamente para teste) para o papel 'anon' na tabela quote_requests
GRANT ALL PRIVILEGES ON TABLE public.quote_requests TO anon;
